...
export default function Home() {
  ...
  const [activeTab, setActiveTab] = useState("canvas"); // Only canvas tab remains
    ...
    <div className="w-full h-screen flex flex-col items-center justify-start p-4 sm:p-6 pt-0 sm:pt-0">
      <div className="w-full flex gap-4 justify-between flex-wrap py-4">
        <div className="flex gap-4 items-center w-full justify-between sm:w-fit">
          <h1 className="text-xl sm:text-3xl font-extrabold opacity-50">Quicc Draw</h1>
        </div>
      ...
      <canvas
        ...
        className="w-full h-full border border-gray-300 rounded-xl block"
        style={{ 
          width: "100%", 
          height: "100%"
        }}
